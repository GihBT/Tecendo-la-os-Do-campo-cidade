...
// ========================================== //
//      LÓGICA DE ACESSIBILIDADE DO SITE      //
// ========================================== //

// 1. Capturando os botões de acessibilidade
const btnAumentar = document.getElementById('btn-aumentar');
const btnDiminuir = document.getElementById('btn-diminuir');
const btnTema = document.getElementById('btn-tema');

// Tamanho da fonte padrão (em pixels)
let tamanhoFonteAtual = 16; 

// Ouvinte de evento para AUMENTAR a letra
btnAumentar.addEventListener('click', () => {
    if (tamanhoFonteAtual < 26) { // Limite máximo para não quebrar o layout
        tamanhoFonteAtual += 2;
        document.body.style.fontSize = tamanhoFonteAtual + 'px';
    }
});

// Ouvinte de evento para DIMINUIR a letra
btnDiminuir.addEventListener('click', () => {
    if (tamanhoFonteAtual > 12) { // Limite mínimo para continuar legível
        tamanhoFonteAtual -= 2;
        document.body.style.fontSize = tamanhoFonteAtual + 'px';
    }
});

// Ouvinte de evento para o modo escuro
